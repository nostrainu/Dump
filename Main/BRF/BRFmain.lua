...
local MainLeftTabbox = Tabs.Main:AddLeftTabbox({
    Name = "Sub Features",
    Center = true,
    IconName = "list",
    Collapsible = true,
...
local Tab1 = MainLeftTabbox:AddTab("Automation")
local Tab2 = MainLeftTabbox:AddTab("Other")

Tab1:AddToggle("TestAutomation", {
    Text = "Enable Automation Test",
    Default = false,
    Callback = function(val)
        print("Automation toggle:", val)
    end
})

Tab2:AddLabel({ Text = "Tabbox Subtab 2 Label" })
...
local MainRightTabbox = Tabs.Main:AddRightTabbox({
    Name = "Right Tabbox",
    Collapsible = true,
    DefaultCollapsed = false
})
local RightTab1 = MainRightTabbox:AddTab("Automation B", "settings")
local RightTab2 = MainRightTabbox:AddTab("Other B", "list")

RightTab1:AddToggle("RightAutomationTest", {
    Text = "Enable Right Automation",
    Default = false,
    Callback = function(val)
        print("Right automation toggle:", val)
    end
})

RightTab2:AddLabel({ Text = "Right tabbox subtab 2 label" })
